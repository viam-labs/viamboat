...
import '../data/boat/service/boat_service_impl.dart' as _i103;
...
import '../data/camera/mapper/viam_camera_data_to_viam_app_camera_data_mapper.dart'
    as _i35;
import '../data/camera/service/camera_service_impl.dart' as _i97;
...
import '../data/data_viam/service/viam_data_service_impl.dart' as _i101;
...
import '../data/permissions/data_source/camera_permission_data_source.dart'
    as _i52;
import '../data/permissions/service/permissions_service_impl.dart' as _i87;
import '../data/resource/data_source/resource_api_data_source.dart' as _i89;
import '../data/resource/mapper/viam_app_resource_name_to_viam_resource_name_mapper.dart'
    as _i32;
import '../data/resource/service/resource_service_impl.dart' as _i99;
...
import '../domain/analytics/usecase/log_add_boat_event_use_case.dart' as _i80;
import '../domain/analytics/usecase/log_delete_boat_event_use_case.dart'
    as _i81;
import '../domain/analytics/usecase/log_open_app_event_use_case.dart' as _i82;
...
import '../domain/app_viam/usecase/connect_app_service_client_use_case.dart'
    as _i60;
import '../domain/app_viam/usecase/get_location_id_use_case.dart' as _i67;
import '../domain/app_viam/usecase/get_location_use_case.dart' as _i68;
import '../domain/app_viam/usecase/get_locations_use_case.dart' as _i69;
import '../domain/app_viam/usecase/get_main_part_address_use_case.dart' as _i70;
import '../domain/app_viam/usecase/get_organization_id_use_case.dart' as _i71;
import '../domain/app_viam/usecase/get_organization_use_case.dart' as _i72;
import '../domain/app_viam/usecase/get_robot_id_use_case.dart' as _i75;
import '../domain/app_viam/usecase/get_robot_use_case.dart' as _i76;
import '../domain/app_viam/usecase/get_robots_use_case.dart' as _i77;
import '../domain/app_viam/usecase/list_organizations_use_case.dart' as _i73;
import '../domain/app_viam/usecase/set_location_id_use_case.dart' as _i91;
import '../domain/app_viam/usecase/set_organization_id_use_case.dart' as _i92;
import '../domain/app_viam/usecase/set_robot_id_use_case.dart' as _i93;
import '../domain/boat/broadcaster/boat_update_broadcaster.dart' as _i5;
import '../domain/boat/service/boat_service.dart' as _i102;
...
import '../domain/boat/usecase/change_boat_name_use_case.dart' as _i104;
...
import '../domain/boat/usecase/subscribe_to_boat_update_stream_use_case.dart'
    as _i21;
import '../domain/camera/service/camera_service.dart' as _i96;
...
import '../domain/data_viam/service/viam_data_service.dart' as _i100;
...
import '../domain/movement/usecase/get_compass_heading_use_case.dart' as _i65;
...
import '../domain/permissions/service/permissions_service.dart' as _i86;
...
import '../domain/permissions/usecase/request_camera_permission_use_case.dart'
    as _i88;
import '../domain/resource/service/resource_service.dart' as _i98;
...
import '../domain/viam/usecase/check_connection_use_case.dart' as _i54;
...
import '../domain/viam/usecase/get_token_or_null_use_case.dart' as _i79;
import '../domain/viam/usecase/logout_use_case.dart' as _i84;
...
import '../presentation/page/fuel_consumption_per_mile/cubit/fuel_consumption_per_mile_page_cubit.dart'
    as _i148;
import '../presentation/page/login/cubit/login_page_cubit.dart' as _i83;
import '../presentation/page/main/cubit/main_cubit.dart' as _i121;
import '../presentation/page/map/cubit/map_cubit.dart' as _i85;
...
import '../presentation/page/splash/cubit/splash_cubit.dart' as _i94;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i54.CheckConnectionUseCase>(
      () => _i54.CheckConnectionUseCase(get<_i40.ViamService>()));
  ...
  gh.factory<_i56.ChoosePhotoForBoatUseCase>(
      () => _i56.ChoosePhotoForBoatUseCase(get<_i13.LocalPhotoService>()));
  ...
  gh.factory<_i60.ConnectAppServiceClinetUseCase>(
      () => _i60.ConnectAppServiceClinetUseCase(get<_i46.AppViamService>()));
  gh.factory<_i61.ConnectToRobotUseCase>(
      () => _i61.ConnectToRobotUseCase(get<_i40.ViamService>()));
  gh.factory<_i62.CurrentBoatStore>(() =>
      _i63.SharedPreferencesCurrentBoatStore(get<_i20.SharedPreferences>()));
  gh.factory<_i64.DataViamDataSource>(() => _i64.DataViamDataSource(
      get<_i28.Viam>(instanceName: 'directDataClient')));
  gh.factory<_i65.GetCompassHeadingUseCase>(
      () => _i65.GetCompassHeadingUseCase(get<_i30.ViamAppMovementService>()));
  gh.factory<_i66.GetLinearVelocityUseCase>(
      () => _i66.GetLinearVelocityUseCase(get<_i30.ViamAppMovementService>()));
  gh.factory<_i67.GetLocationIdUseCase>(
      () => _i67.GetLocationIdUseCase(get<_i48.AppViamStore>()));
  gh.factory<_i68.GetLocationUseCase>(
      () => _i68.GetLocationUseCase(get<_i46.AppViamService>()));
  gh.factory<_i69.GetLocationsUseCase>(
      () => _i69.GetLocationsUseCase(get<_i46.AppViamService>()));
  gh.factory<_i70.GetMainPartAddressUseCase>(
      () => _i70.GetMainPartAddressUseCase(get<_i46.AppViamService>()));
  gh.factory<_i71.GetOrganizationIdUseCase>(
      () => _i71.GetOrganizationIdUseCase(get<_i48.AppViamStore>()));
  gh.factory<_i72.GetOrganizationUseCase>(
      () => _i72.GetOrganizationUseCase(get<_i46.AppViamService>()));
  gh.factory<_i73.GetOrganizationsListUseCase>(
      () => _i73.GetOrganizationsListUseCase(get<_i46.AppViamService>()));
  gh.factory<_i74.GetPostionUseCase>(
      () => _i74.GetPostionUseCase(get<_i30.ViamAppMovementService>()));
  gh.factory<_i75.GetRobotIdUseCase>(
      () => _i75.GetRobotIdUseCase(get<_i48.AppViamStore>()));
  gh.factory<_i76.GetRobotUseCase>(
      () => _i76.GetRobotUseCase(get<_i46.AppViamService>()));
  gh.factory<_i77.GetRobotsUseCase>(
      () => _i77.GetRobotsUseCase(get<_i46.AppViamService>()));
  gh.factory<_i78.GetSensorDataUseCase>(
      () => _i78.GetSensorDataUseCase(get<_i33.ViamAppSensorService>()));
  gh.factory<_i79.GetTokenOrNullUseCase>(
      () => _i79.GetTokenOrNullUseCase(get<_i25.TokenStore>()));
  gh.factory<_i80.LogAddBoatEventUseCase>(
      () => _i80.LogAddBoatEventUseCase(get<_i43.AnalyticsService>()));
  gh.factory<_i81.LogDeleteBoatEventUseCase>(
      () => _i81.LogDeleteBoatEventUseCase(get<_i43.AnalyticsService>()));
  gh.factory<_i82.LogOpenAppEventUseCase>(
      () => _i82.LogOpenAppEventUseCase(get<_i43.AnalyticsService>()));
  gh.factory<_i83.LoginPageCubit>(
      () => _i83.LoginPageCubit(get<_i50.AuthenticateUseCase>()));
  gh.factory<_i84.LogoutUseCase>(
      () => _i84.LogoutUseCase(get<_i40.ViamService>()));
  gh.factory<_i85.MapCubit>(() => _i85.MapCubit(
        get<_i74.GetPostionUseCase>(),
        get<_i9.GetCurrentTimeUseCase>(),
        get<_i65.GetCompassHeadingUseCase>(),
      ));
  gh.lazySingleton<_i86.PermissionsService>(() =>
      _i87.PermissionsServiceImpl(get<_i52.CameraPermissionDataSource>()));
  gh.factory<_i88.RequestCameraPermissionUseCase>(() =>
      _i88.RequestCameraPermissionUseCase(get<_i86.PermissionsService>()));
  gh.factory<_i89.ResourceDataSource>(
      () => _i89.ResourceDataSource(get<_i17.RobotManager>()));
  gh.factory<_i90.SensorTileCubit>(() => _i90.SensorTileCubit(
        get<_i78.GetSensorDataUseCase>(),
        get<_i66.GetLinearVelocityUseCase>(),
        get<_i9.GetCurrentTimeUseCase>(),
        get<_i65.GetCompassHeadingUseCase>(),
      ));
  gh.factory<_i91.SetLocationIdUseCase>(
      () => _i91.SetLocationIdUseCase(get<_i48.AppViamStore>()));
  gh.factory<_i92.SetOrganizationIdUseCase>(
      () => _i92.SetOrganizationIdUseCase(get<_i48.AppViamStore>()));
  gh.factory<_i93.SetRobotIdUseCase>(
      () => _i93.SetRobotIdUseCase(get<_i48.AppViamStore>()));
  gh.factory<_i94.SplashCubit>(() =>
      _i94.SplashCubit(get<_i55.CheckIfHasTokenAndRefreshTokenUseCase>()));
  gh.factory<_i95.SubscribeToTokenExpiredStreamUseCase>(() =>
      _i95.SubscribeToTokenExpiredStreamUseCase(
          get<_i23.TokenExpiredBroadcaster>()));
  gh.factory<_i96.ViamAppCameraService>(() => _i97.ViamAppCameraServiceImpl(
        get<_i23.TokenExpiredBroadcaster>(),
        get<_i51.CameraDataSource>(),
        get<_i35.ViamCameraDataToViamAppCameraDataMapper>(),
      ));
  gh.factory<_i98.ViamAppResourceService>(() => _i99.ViamAppResourceServiceImpl(
        get<_i23.TokenExpiredBroadcaster>(),
        get<_i89.ResourceDataSource>(),
      ));
  gh.lazySingleton<_i100.ViamDataService>(() => _i101.ViamDataServiceImpl(
        get<_i23.TokenExpiredBroadcaster>(),
        get<_i64.DataViamDataSource>(),
      ));
  gh.factory<_i102.BoatService>(() => _i103.BoatServiceImpl(
        get<_i3.BoatBox>(),
        get<_i62.CurrentBoatStore>(),
      ));
  gh.factory<_i104.ChangeBoatNameUseCase>(
      () => _i104.ChangeBoatNameUseCase(get<_i102.BoatService>()));
  gh.factory<_i105.ConnectToViamAppUseCase>(
      () => _i105.ConnectToViamAppUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i106.DeleteBoatUseCase>(
      () => _i106.DeleteBoatUseCase(get<_i102.BoatService>()));
  gh.factory<_i107.GetBinaryDataByFilterUseCase>(
      () => _i107.GetBinaryDataByFilterUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i108.GetBoatsUseCase>(
      () => _i108.GetBoatsUseCase(get<_i102.BoatService>()));
  gh.factory<_i109.GetCameraDataUseCase>(
      () => _i109.GetCameraDataUseCase(get<_i96.ViamAppCameraService>()));
  gh.factory<_i110.GetCameraPermissionStatusUseCase>(() =>
      _i110.GetCameraPermissionStatusUseCase(get<_i86.PermissionsService>()));
  gh.factory<_i111.GetCameraVideoUseCase>(
      () => _i111.GetCameraVideoUseCase(get<_i96.ViamAppCameraService>()));
  gh.factory<_i112.GetCurrentBoatIdUseCase>(
      () => _i112.GetCurrentBoatIdUseCase(get<_i102.BoatService>()));
  gh.factory<_i113.GetCurrentWaterFiltersUseCase>(
      () => _i113.GetCurrentWaterFiltersUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i114.GetDepthOverTimeDataUseCase>(
      () => _i114.GetDepthOverTimeDataUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i115.GetFuelConsumptionOverTimeDataUseCase>(() =>
      _i115.GetFuelConsumptionOverTimeDataUseCase(
          get<_i100.ViamDataService>()));
  gh.factory<_i116.GetFuelConsumptionPerMileDataUseCase>(() =>
      _i116.GetFuelConsumptionPerMileDataUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i117.GetResourceNamesUseCase>(
      () => _i117.GetResourceNamesUseCase(get<_i98.ViamAppResourceService>()));
  gh.factory<_i118.GetTabularDataByFilterUseCase>(
      () => _i118.GetTabularDataByFilterUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i119.GetWaterDepthDataUseCase>(
      () => _i119.GetWaterDepthDataUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i120.GetWaterTemperatureDataUseCase>(
      () => _i120.GetWaterTemperatureDataUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i121.MainCubit>(() => _i121.MainCubit(
        get<_i117.GetResourceNamesUseCase>(),
        get<_i79.GetTokenOrNullUseCase>(),
        get<_i95.SubscribeToTokenExpiredStreamUseCase>(),
        get<_i59.ClearCacheUseCase>(),
        get<_i61.ConnectToRobotUseCase>(),
        get<_i54.CheckConnectionUseCase>(),
      ));
  gh.factory<_i122.RemoveCurrentBoatIdUseCase>(
      () => _i122.RemoveCurrentBoatIdUseCase(get<_i102.BoatService>()));
  gh.factory<_i123.SetCurrentBoatIdUseCase>(
      () => _i123.SetCurrentBoatIdUseCase(get<_i102.BoatService>()));
  gh.factory<_i124.SetDepthOverTimeFiltersUseCase>(
      () => _i124.SetDepthOverTimeFiltersUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i125.SetWaterDepthFiltersUseCase>(
      () => _i125.SetWaterDepthFiltersUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i126.SetWaterTemperatureFiltersUseCase>(() =>
      _i126.SetWaterTemperatureFiltersUseCase(get<_i100.ViamDataService>()));
  gh.factory<_i127.SettingsCubit>(() => _i127.SettingsCubit(
        ...
        get<_i84.LogoutUseCase>(),
        get<_i59.ClearCacheUseCase>(),
      ));
  gh.factory<_i128.SubscribeToCameraStreamUseCase>(() =>
      _i128.SubscribeToCameraStreamUseCase(get<_i96.ViamAppCameraService>()));
  gh.factory<_i129.SubscribeToRefreshFiltersUseCase>(() =>
      _i129.SubscribeToRefreshFiltersUseCase(get<_i100.ViamDataService>()));
  ...
  gh.factory<_i135.AddNewBoatUseCase>(
      () => _i135.AddNewBoatUseCase(get<_i102.BoatService>()));
  ...
  gh.factory<_i139.ChangeBoatNameCubit>(() => _i139.ChangeBoatNameCubit(
        get<_i104.ChangeBoatNameUseCase>(),
  ...
  gh.factory<_i140.ConnectionErrorCubit>(() => _i140.ConnectionErrorCubit(
        ...
        get<_i108.GetBoatsUseCase>(),
        get<_i70.GetMainPartAddressUseCase>(),
      ));
  ...
  gh.factory<_i149.SelectRobotCubit>(() => _i149.SelectRobotCubit(
        ...
        get<_i61.ConnectToRobotUseCase>(),
        get<_i108.GetBoatsUseCase>(),
        get<_i67.GetLocationIdUseCase>(),
        get<_i69.GetLocationsUseCase>(),
        get<_i71.GetOrganizationIdUseCase>(),
        get<_i73.GetOrganizationsListUseCase>(),
        get<_i70.GetMainPartAddressUseCase>(),
        get<_i75.GetRobotIdUseCase>(),
        get<_i77.GetRobotsUseCase>(),
        get<_i79.GetTokenOrNullUseCase>(),
        get<_i91.SetLocationIdUseCase>(),
        get<_i92.SetOrganizationIdUseCase>(),
        get<_i93.SetRobotIdUseCase>(),
        get<_i95.SubscribeToTokenExpiredStreamUseCase>(),
        get<_i59.ClearCacheUseCase>(),
        get<_i84.LogoutUseCase>(),
        get<_i60.ConnectAppServiceClinetUseCase>(),
      ));
  return get;
}
