...
class WaterTempPopup extends StatelessWidget with ExtensionMixin {
          ...
          child: Column(
            ...
            children: [
              MapPopupText(
                ...
                secondText: '${waterTemperature.temperature}',
              ),
              MapPopupText(
                firstText: 'Date: ',
              ...
              MapPopupText(
                firstText: 'Coords: ',
                secondText: '${waterTemperature.lat}, ${waterTemperature.long}',
              ),
            ],
          ),
        ),
