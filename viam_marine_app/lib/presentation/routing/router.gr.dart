...
import '../../domain/app_viam/model/robot_config.dart' as _i20;
import '../../domain/app_viam/model/viam_app_robot.dart' as _i22;
import '../../domain/boat/model/viam_boat.dart' as _i21;
import '../../domain/data_viam/model/filter_type.dart' as _i23;
import '../../domain/error/model/viam_error.dart' as _i19;
import '../../domain/resource/model/viam_app_resource_name.dart' as _i24;
...
class MainRouter extends _i17.RootStackRouter {
  ...
  final Map<String, _i17.PageFactory> pagesMap = {
    ...
    SelectRobotRoute.name: (routeData) {
      return _i17.CustomPage<dynamic>(
        routeData: routeData,
        child: _i17.WrappedRoute(child: const _i10.SelectRobotPage()),
        transitionsBuilder: _i17.TransitionsBuilders.fadeIn,
        opaque: true,
        barrierDismissible: false,
      );
...
class MainRoute extends _i17.PageRouteInfo<MainRouteArgs> {
  MainRoute({
    _i18.Key? key,
    required _i20.RobotConfig robotConfig,
...
class MainRouteArgs {
  ...
  final _i20.RobotConfig robotConfig;
...
class ConnectionErrorRoute
  ...
  ConnectionErrorRoute({
    _i18.Key? key,
    String? secret,
    required _i22.ViamAppRobot robot,
  }) : super(
          ConnectionErrorRoute.name,
          path: '/connection-error-page',
...
class SelectRobotRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i11.FiltersPage]
class FiltersRoute extends _i17.PageRouteInfo<FiltersRouteArgs> {
  FiltersRoute({
...
class DashboardRoute extends _i17.PageRouteInfo<DashboardRouteArgs> {
  DashboardRoute({
    required List<_i24.ViamAppResourceName> sensors,
    required _i20.RobotConfig robotConfig,
    _i18.Key? key,
  }) : super(
          DashboardRoute.name,
...
class DashboardRouteArgs {
  ...
  final List<_i24.ViamAppResourceName> sensors;
...
class CameraRoute extends _i17.PageRouteInfo<CameraRouteArgs> {
  CameraRoute({
    required List<_i24.ViamAppResourceName> cameraSensors,
    _i18.Key? key,
  }) : super(
          CameraRoute.name,
          path: 'camera-page',
...
class CameraRouteArgs {
  ...
  final List<_i24.ViamAppResourceName> cameraSensors;
...
class MapRoute extends _i17.PageRouteInfo<MapRouteArgs> {
  MapRoute({
    required _i24.ViamAppResourceName? resourceName,
    _i18.Key? key,
  }) : super(
          MapRoute.name,
          path: 'map-page',
...
class MapRouteArgs {
  ...
  final _i24.ViamAppResourceName? resourceName;
