...
class FrameSystemConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FrameSystemConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.robot.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.PoseInFrame>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'poseInParentFrame', subBuilder: $1.PoseInFrame.create)
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelJson', $pb.PbFieldType.OY)
  ...
  factory FrameSystemConfig({
    $core.String? name,
    $1.PoseInFrame? poseInParentFrame,
    $core.List<$core.int>? modelJson,
  }) {
    final _result = create();
    if (name != null) {
      _result.name = name;
    }
    if (poseInParentFrame != null) {
      _result.poseInParentFrame = poseInParentFrame;
    }
    if (modelJson != null) {
      _result.modelJson = modelJson;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  $1.PoseInFrame get poseInParentFrame => $_getN(1);
  @$pb.TagNumber(2)
  set poseInParentFrame($1.PoseInFrame v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPoseInParentFrame() => $_has(1);
  @$pb.TagNumber(2)
  void clearPoseInParentFrame() => clearField(2);
  @$pb.TagNumber(2)
  $1.PoseInFrame ensurePoseInParentFrame() => $_ensure(1);

  @$pb.TagNumber(3)
  $core.List<$core.int> get modelJson => $_getN(2);
  @$pb.TagNumber(3)
  set modelJson($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasModelJson() => $_has(2);
  @$pb.TagNumber(3)
  void clearModelJson() => clearField(3);
}
