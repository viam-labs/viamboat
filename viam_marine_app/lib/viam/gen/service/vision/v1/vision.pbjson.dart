...
final $typed_data.Uint8List getModelParameterSchemaRequestDescriptor = $convert.base64Decode('Ch5HZXRNb2RlbFBhcmFtZXRlclNjaGVtYVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIdCgptb2RlbF90eXBlGAIgASgJUgltb2RlbFR5cGU=');
...
final $typed_data.Uint8List getDetectorNamesRequestDescriptor = $convert.base64Decode('ChdHZXREZXRlY3Rvck5hbWVzUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');
...
final $typed_data.Uint8List addDetectorRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List removeDetectorRequestDescriptor = $convert.base64Decode('ChVSZW1vdmVEZXRlY3RvclJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIjCg1kZXRlY3Rvcl9uYW1lGAIgASgJUgxkZXRlY3Rvck5hbWU=');
...
final $typed_data.Uint8List getDetectionsRequestDescriptor = $convert.base64Decode('ChRHZXREZXRlY3Rpb25zUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEhQKBWltYWdlGAIgASgMUgVpbWFnZRIUCgV3aWR0aBgDIAEoA1IFd2lkdGgSFgoGaGVpZ2h0GAQgASgDUgZoZWlnaHQSGwoJbWltZV90eXBlGAUgASgJUghtaW1lVHlwZRIjCg1kZXRlY3Rvcl9uYW1lGAYgASgJUgxkZXRlY3Rvck5hbWU=');
...
final $typed_data.Uint8List getDetectionsFromCameraRequestDescriptor = $convert.base64Decode('Ch5HZXREZXRlY3Rpb25zRnJvbUNhbWVyYVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIfCgtjYW1lcmFfbmFtZRgCIAEoCVIKY2FtZXJhTmFtZRIjCg1kZXRlY3Rvcl9uYW1lGAMgASgJUgxkZXRlY3Rvck5hbWU=');
...
final $typed_data.Uint8List getClassifierNamesRequestDescriptor = $convert.base64Decode('ChlHZXRDbGFzc2lmaWVyTmFtZXNSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List addClassifierRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List removeClassifierRequestDescriptor = $convert.base64Decode('ChdSZW1vdmVDbGFzc2lmaWVyUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEicKD2NsYXNzaWZpZXJfbmFtZRgCIAEoCVIOY2xhc3NpZmllck5hbWU=');
...
final $typed_data.Uint8List getClassificationsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getClassificationsFromCameraRequestDescriptor = $convert.base64Decode('CiNHZXRDbGFzc2lmaWNhdGlvbnNGcm9tQ2FtZXJhUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEh8KC2NhbWVyYV9uYW1lGAIgASgJUgpjYW1lcmFOYW1lEicKD2NsYXNzaWZpZXJfbmFtZRgDIAEoCVIOY2xhc3NpZmllck5hbWUSDAoBbhgEIAEoBVIBbg==');
...
final $typed_data.Uint8List getSegmenterNamesRequestDescriptor = $convert.base64Decode('ChhHZXRTZWdtZW50ZXJOYW1lc1JlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List addSegmenterRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List removeSegmenterRequestDescriptor = $convert.base64Decode('ChZSZW1vdmVTZWdtZW50ZXJSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSJQoOc2VnbWVudGVyX25hbWUYAiABKAlSDXNlZ21lbnRlck5hbWU=');
...
final $typed_data.Uint8List getObjectPointCloudsRequestDescriptor = $convert.base64Decode('ChtHZXRPYmplY3RQb2ludENsb3Vkc1JlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIfCgtjYW1lcmFfbmFtZRgCIAEoCVIKY2FtZXJhTmFtZRIlCg5zZWdtZW50ZXJfbmFtZRgDIAEoCVINc2VnbWVudGVyTmFtZRIbCgltaW1lX3R5cGUYBCABKAlSCG1pbWVUeXBl');
