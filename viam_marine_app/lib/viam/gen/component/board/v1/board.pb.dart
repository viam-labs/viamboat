...
class StatusResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StatusResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.component.board.v1'), createEmptyInstance: create)
    ..aOM<$2.BoardStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: $2.BoardStatus.create)
    ..hasRequiredFields = false
  ;

  StatusResponse._() : super();
  factory StatusResponse({
    $2.BoardStatus? status,
  }) {
    final _result = create();
    if (status != null) {
  ...
  @$pb.TagNumber(1)
  $2.BoardStatus get status => $_getN(0);
  @$pb.TagNumber(1)
  set status($2.BoardStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearStatus() => clearField(1);
  @$pb.TagNumber(1)
  $2.BoardStatus ensureStatus() => $_ensure(0);
}
