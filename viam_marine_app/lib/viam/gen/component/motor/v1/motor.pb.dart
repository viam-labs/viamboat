...
class Status extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Status', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.component.motor.v1'), createEmptyInstance: create)
    ...
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'positionReporting')
  ...
  @$pb.TagNumber(2)
  $core.bool get positionReporting => $_getBF(1);
  @$pb.TagNumber(2)
  set positionReporting($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasPositionReporting() => $_has(1);
  @$pb.TagNumber(2)
  void clearPositionReporting() => clearField(2);

  @$pb.TagNumber(3)
  $core.double get position => $_getN(2);
  @$pb.TagNumber(3)
  set position($core.double v) { $_setDouble(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $core.bool get isMoving => $_getBF(3);
  @$pb.TagNumber(4)
  set isMoving($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasIsMoving() => $_has(3);
  @$pb.TagNumber(4)
