...
class GetEndPositionResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetEndPositionResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.component.arm.v1'), createEmptyInstance: create)
    ..aOM<$2.Pose>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pose', subBuilder: $2.Pose.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $2.Pose get pose => $_getN(0);
  @$pb.TagNumber(1)
  set pose($2.Pose v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPose() => $_has(0);
  @$pb.TagNumber(1)
  void clearPose() => clearField(1);
  @$pb.TagNumber(1)
  $2.Pose ensurePose() => $_ensure(0);
}
...
class MoveToPositionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MoveToPositionRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.component.arm.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$2.Pose>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'to', subBuilder: $2.Pose.create)
    ..aOM<$2.WorldState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'worldState', subBuilder: $2.WorldState.create)
    ..aOM<$1.Struct>(99, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extra', subBuilder: $1.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2.Pose get to => $_getN(1);
  @$pb.TagNumber(2)
  set to($2.Pose v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTo() => $_has(1);
  @$pb.TagNumber(2)
  void clearTo() => clearField(2);
  @$pb.TagNumber(2)
  $2.Pose ensureTo() => $_ensure(1);

  @$pb.TagNumber(3)
  $2.WorldState get worldState => $_getN(2);
  @$pb.TagNumber(3)
  set worldState($2.WorldState v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasWorldState() => $_has(2);
  @$pb.TagNumber(3)
  void clearWorldState() => clearField(3);
  @$pb.TagNumber(3)
  $2.WorldState ensureWorldState() => $_ensure(2);
...
class Status extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Status', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.component.arm.v1'), createEmptyInstance: create)
    ..aOM<$2.Pose>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endPosition', subBuilder: $2.Pose.create)
  ...
  @$pb.TagNumber(1)
  $2.Pose get endPosition => $_getN(0);
  @$pb.TagNumber(1)
  set endPosition($2.Pose v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEndPosition() => $_has(0);
  @$pb.TagNumber(1)
  void clearEndPosition() => clearField(1);
  @$pb.TagNumber(1)
  $2.Pose ensureEndPosition() => $_ensure(0);
