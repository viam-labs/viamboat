...
class SetPowerRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetPowerRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.component.base.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$2.Vector3>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linear', subBuilder: $2.Vector3.create)
    ..aOM<$2.Vector3>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'angular', subBuilder: $2.Vector3.create)
    ..aOM<$1.Struct>(99, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extra', subBuilder: $1.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2.Vector3 get linear => $_getN(1);
  @$pb.TagNumber(2)
  set linear($2.Vector3 v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLinear() => $_has(1);
  @$pb.TagNumber(2)
  void clearLinear() => clearField(2);
  @$pb.TagNumber(2)
  $2.Vector3 ensureLinear() => $_ensure(1);

  @$pb.TagNumber(3)
  $2.Vector3 get angular => $_getN(2);
  @$pb.TagNumber(3)
  set angular($2.Vector3 v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAngular() => $_has(2);
  @$pb.TagNumber(3)
  void clearAngular() => clearField(3);
  @$pb.TagNumber(3)
  $2.Vector3 ensureAngular() => $_ensure(2);
