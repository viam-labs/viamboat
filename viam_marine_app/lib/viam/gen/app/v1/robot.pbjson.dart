...
final $typed_data.Uint8List robotConfigDescriptor = $convert.base64Decode('');
...
const CloudConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'location_secret', '3': 7, '4': 1, '5': 9, '10': 'locationSecret'},
    const {'1': 'secret', '3': 8, '4': 1, '5': 9, '10': 'secret'},
  ],
};

/// Descriptor for `CloudConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List cloudConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List componentConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List processConfigDescriptor = $convert.base64Decode('Cg1Qcm9jZXNzQ29uZmlnEg4KAmlkGAEgASgJUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEhIKBGFyZ3MYAyADKAlSBGFyZ3MSEAoDY3dkGAQgASgJUgNjd2QSGQoIb25lX3Nob3QYBSABKAhSB29uZVNob3QSEAoDbG9nGAYgASgIUgNsb2c=');
...
final $typed_data.Uint8List serviceConfigDescriptor = $convert.base64Decode('Cg1TZXJ2aWNlQ29uZmlnEhIKBG5hbWUYASABKAlSBG5hbWUSHAoJbmFtZXNwYWNlGAIgASgJUgluYW1lc3BhY2USEgoEdHlwZRgDIAEoCVIEdHlwZRI3CgphdHRyaWJ1dGVzGAQgASgLMhcuZ29vZ2xlLnByb3RvYnVmLlN0cnVjdFIKYXR0cmlidXRlcw==');
...
final $typed_data.Uint8List frameDescriptor = $convert.base64Decode('CgVGcmFtZRIWCgZwYXJlbnQYASABKAlSBnBhcmVudBI6Cgt0cmFuc2xhdGlvbhgCIAEoCzIYLnZpYW0uYXBwLnYxLlRyYW5zbGF0aW9uUgt0cmFuc2xhdGlvbhI6CgtvcmllbnRhdGlvbhgDIAEoCzIYLnZpYW0uYXBwLnYxLk9yaWVudGF0aW9uUgtvcmllbnRhdGlvbg==');
