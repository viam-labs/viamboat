...
class UploadRequest extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, UploadRequest_UploadPacket> _UploadRequest_UploadPacketByTag = {
    ...
    2 : UploadRequest_UploadPacket.sensorContents,
    3 : UploadRequest_UploadPacket.fileContents,
    0 : UploadRequest_UploadPacket.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.app.datasync.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<UploadMetadata>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: UploadMetadata.create)
    ..aOM<SensorData>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sensorContents', subBuilder: SensorData.create)
    ..aOM<FileData>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileContents', subBuilder: FileData.create)
    ..hasRequiredFields = false
  ;
  ...
  factory UploadRequest({
    ...
    if (sensorContents != null) {
      _result.sensorContents = sensorContents;
    }
  ...
  @$pb.TagNumber(2)
  SensorData get sensorContents => $_getN(1);
  @$pb.TagNumber(2)
  set sensorContents(SensorData v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSensorContents() => $_has(1);
  @$pb.TagNumber(2)
  void clearSensorContents() => clearField(2);
  @$pb.TagNumber(2)
  SensorData ensureSensorContents() => $_ensure(1);

  @$pb.TagNumber(3)
  FileData get fileContents => $_getN(2);
  @$pb.TagNumber(3)
  set fileContents(FileData v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasFileContents() => $_has(2);
  @$pb.TagNumber(3)
  void clearFileContents() => clearField(3);
  @$pb.TagNumber(3)
  FileData ensureFileContents() => $_ensure(2);
}

class UploadResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.app.datasync.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestsWritten', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  UploadResponse._() : super();
  factory UploadResponse({
    $core.int? requestsWritten,
  }) {
    final _result = create();
    if (requestsWritten != null) {
      _result.requestsWritten = requestsWritten;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(1)
  $core.int get requestsWritten => $_getIZ(0);
  @$pb.TagNumber(1)
  set requestsWritten($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasRequestsWritten() => $_has(0);
  @$pb.TagNumber(1)
  void clearRequestsWritten() => clearField(1);
}
...
class UserFile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserFile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.app.datasync.v1'), createEmptyInstance: create)
    ..aOM<$1.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'syncTime', subBuilder: $1.Timestamp.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orgId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'robotId')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partId')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationId')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'blobPath')
    ..m<$core.String, $3.Any>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'methodParameters', entryClassName: 'UserFile.MethodParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $3.Any.create, packageName: const $pb.PackageName('viam.app.datasync.v1'))
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileId')
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileSizeBytes')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mimeType')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserFile copyWith(void Function(UserFile) updates) => super.copyWith((message) => updates(message as UserFile)) as UserFile; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $1.Timestamp get syncTime => $_getN(0);
  @$pb.TagNumber(1)
  set syncTime($1.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSyncTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearSyncTime() => clearField(1);
  @$pb.TagNumber(1)
  $1.Timestamp ensureSyncTime() => $_ensure(0);
  ...
  @$pb.TagNumber(9)
  void clearFileSizeBytes() => clearField(9);
