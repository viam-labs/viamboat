...
class _$WebrtcCameraStateLoaded implements WebrtcCameraStateLoaded {
  const _$WebrtcCameraStateLoaded();

  @override
  String toString() {
    return 'WebrtcCameraState.loaded()';
  }
...
abstract class WebrtcCameraStateLoaded implements WebrtcCameraState {
  const factory WebrtcCameraStateLoaded() = _$WebrtcCameraStateLoaded;
}
...
class _$WebrtcCameraStateError implements WebrtcCameraStateError {
  ...
  @override
  String toString() {
    return 'WebrtcCameraState.error()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$WebrtcCameraStateError);
  }
...
abstract class WebrtcCameraStateError implements WebrtcCameraState {
  const factory WebrtcCameraStateError() = _$WebrtcCameraStateError;
}
