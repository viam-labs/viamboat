...
import '../data/camera/mapper/viam_camera_data_to_viam_app_camera_data_mapper.dart'
    as _i10;
import '../data/camera/service/camera_service_impl.dart' as _i24;
...
import '../data/movement/mapper/viam_position_to_viam_app_position_mapper.dart'
    as _i11;
import '../data/movement/service/movement_service_impl.dart' as _i27;
import '../data/resource/data_source/resource_api_data_source.dart' as _i16;
...
import '../data/resource/mapper/viam_resource_name_to_viam_app_resource_name_mapper.dart'
    as _i12;
import '../data/resource/service/resource_service_impl.dart' as _i18;
...
import '../domain/sensor/service/sensor_service_impl.dart' as _i20;
import '../presentation/page/dashboard/cubit/dashboard_cubit.dart' as _i29;
...
import '../presentation/widgets/camera_tile/cubit/camera_tile_cubit.dart'
    as _i28;
import '../presentation/widgets/map_tile/cubit/map_tile_cubit.dart' as _i30;
import '../presentation/widgets/sensor_tile/cubit/sensor_tile_cubit.dart'
    as _i22;
import 'navigator_key_injectable.dart' as _i31;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i15.CameraDataSource>(
      () => _i15.CameraDataSource(get<_i13.ViamSdk>()));
  gh.factory<_i16.ResourceDataSource>(
      () => _i16.ResourceDataSource(get<_i13.ViamSdk>()));
  gh.factory<_i17.ResourceService>(() => _i18.ResourceServiceImpl(
        get<_i16.ResourceDataSource>(),
        get<_i12.ViamResourceNameToViamAppResourceNameMapper>(),
      ));
  gh.factory<_i19.SensorDataSource>(
      () => _i19.SensorDataSource(get<_i13.ViamSdk>()));
  gh.factory<_i20.SensorService>(() => _i21.SensorServiceImpl(
  ...
  gh.factory<_i22.SensorTileCubit>(
      () => _i22.SensorTileCubit(get<_i20.SensorService>()));
  gh.factory<_i23.ViamAppCameraService>(() => _i24.ViamAppCameraServiceImpl(
        get<_i15.CameraDataSource>(),
        get<_i10.ViamCameraDataToViamAppCameraDataMapper>(),
      ));
  gh.factory<_i25.ViamAppMovementSdkDataSource>(
      () => _i25.ViamAppMovementSdkDataSource(get<_i13.ViamSdk>()));
  gh.factory<_i26.ViamAppMovementService>(() => _i27.ViamAppMovementServiceImpl(
        get<_i25.ViamAppMovementSdkDataSource>(),
        get<_i9.ViamAppResourceNameToViamResourceNameMapper>(),
        get<_i11.ViamPositionToViamAppPositionMapper>(),
      ));
  gh.factory<_i28.CameraTileCubit>(
      () => _i28.CameraTileCubit(get<_i23.ViamAppCameraService>()));
  gh.factory<_i29.DashboardCubit>(
      () => _i29.DashboardCubit(get<_i17.ResourceService>()));
  gh.factory<_i30.MapTileCubit>(() => _i30.MapTileCubit(
        get<_i26.ViamAppMovementService>(),
        get<_i20.SensorService>(),
      ));
  return get;
}

class _$NavigatorKeyModule extends _i31.NavigatorKeyModule {}

class _$ViamModule extends _i32.ViamModule {}
