...
import '../data/boat/service/boat_service_impl.dart' as _i86;
...
import '../data/camera/mapper/viam_camera_data_to_viam_app_camera_data_mapper.dart'
    as _i29;
import '../data/camera/service/camera_service_impl.dart' as _i78;
...
import '../data/movement/mapper/viam_position_to_viam_app_position_mapper.dart'
    as _i32;
import '../data/movement/service/movement_service_impl.dart' as _i80;
import '../data/permissions/data_source/camera_permission_data_source.dart'
    as _i47;
import '../data/permissions/service/permissions_service_impl.dart' as _i69;
import '../data/resource/data_source/resource_api_data_source.dart' as _i71;
...
import '../data/resource/mapper/viam_resource_name_to_viam_app_resource_name_mapper.dart'
    as _i33;
import '../data/resource/service/resource_service_impl.dart' as _i82;
import '../data/sensor/data_source/sensor_api_data_source.dart' as _i72;
import '../data/sensor/mapper/viam_sensor_readings_to_viam_app_sensor_readings.dart'
    as _i34;
import '../data/sensor/service/sensor_service_impl.dart' as _i84;
...
import '../domain/analytics/usecase/log_add_boat_event_use_case.dart' as _i64;
import '../domain/analytics/usecase/log_delete_boat_event_use_case.dart'
    as _i65;
import '../domain/analytics/usecase/log_open_app_event_use_case.dart' as _i66;
...
import '../domain/app_viam/usecase/set_location_id_use_case.dart' as _i73;
import '../domain/app_viam/usecase/set_organization_id_use_case.dart' as _i74;
import '../domain/app_viam/usecase/set_robot_id_use_case.dart' as _i75;
import '../domain/boat/broadcaster/boat_update_broadcaster.dart' as _i6;
import '../domain/boat/service/boat_service.dart' as _i85;
import '../domain/boat/store/boat_box.dart' as _i4;
import '../domain/boat/store/current_boat_store.dart' as _i52;
import '../domain/boat/usecase/add_new_boat_use_case.dart' as _i108;
import '../domain/boat/usecase/change_boat_name_use_case.dart' as _i87;
import '../domain/boat/usecase/check_connection_use_case.dart' as _i88;
import '../domain/boat/usecase/delete_boat_use_case.dart' as _i89;
import '../domain/boat/usecase/get_boats_use_case.dart' as _i90;
import '../domain/boat/usecase/get_current_boat_id_use_case.dart' as _i94;
...
import '../domain/boat/usecase/set_current_boat_id_use_case.dart' as _i104;
import '../domain/boat/usecase/subscribe_to_boat_update_stream_use_case.dart'
    as _i21;
import '../domain/camera/service/camera_service.dart' as _i77;
import '../domain/camera/usecase/get_camera_data_use_case.dart' as _i91;
import '../domain/camera/usecase/get_camera_video_use_case.dart' as _i93;
...
import '../domain/local_photo/use_case/choose_photo_for_boat_use_case.dart'
    as _i50;
import '../domain/movement/service/movement_service.dart' as _i79;
import '../domain/movement/usecase/get_linear_velocity_use_case.dart' as _i95;
import '../domain/movement/usecase/get_position_use_case.dart' as _i96;
import '../domain/permissions/service/permissions_service.dart' as _i68;
...
import '../domain/permissions/usecase/request_camera_permission_use_case.dart'
    as _i70;
import '../domain/resource/service/resource_service.dart' as _i81;
import '../domain/resource/usecase/get_resource_names_use_case.dart' as _i97;
import '../domain/sensor/service/sensor_service_impl.dart' as _i83;
...
import '../domain/viam/usecase/logout_use_case.dart' as _i67;
import '../presentation/page/add_boat/cubit/add_boat_cubit.dart' as _i115;
import '../presentation/page/analytics/cubit/analytics_cubit.dart' as _i3;
import '../presentation/page/boat_list/cubit/boat_list_cubit.dart' as _i109;
...
import '../presentation/page/connection_error/cubit/connection_error_cubit.dart'
    as _i112;
import '../presentation/page/dashboard/cubit/dashboard_cubit.dart' as _i113;
import '../presentation/page/locations/cubit/locations_page_cubit.dart'
    as _i114;
import '../presentation/page/main/cubit/main_cubit.dart' as _i99;
import '../presentation/page/map/cubit/map_cubit.dart' as _i100;
...
import '../presentation/page/settings/cubit/settings_cubit.dart' as _i105;
import '../presentation/page/splash/cubit/splash_cubit.dart' as _i76;
import '../presentation/widgets/camera_tile/cubit/camera_tile_cubit.dart'
    as _i110;
import '../presentation/widgets/sensor_tile/cubit/sensor_tile_cubit.dart'
    as _i103;
import 'camera_permission_injectable.dart' as _i120;
import 'file_picker_injectable.dart' as _i116;
import 'firebase_analytics_injectable/analytics_injectable.dart' as _i117;
import 'image_picker_injectable.dart' as _i119;
import 'navigator_key_injectable.dart' as _i118;
import 'shared_preferences_injectable.dart' as _i121;
import 'uuid_injectable.dart' as _i122;
import 'viam_sdk_injectable/viam_sdk_injectable.dart' as _i123;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i64.LogAddBoatEventUseCase>(
      () => _i64.LogAddBoatEventUseCase(get<_i38.AnalyticsService>()));
  gh.factory<_i65.LogDeleteBoatEventUseCase>(
      () => _i65.LogDeleteBoatEventUseCase(get<_i38.AnalyticsService>()));
  gh.factory<_i66.LogOpenAppEventUseCase>(
      () => _i66.LogOpenAppEventUseCase(get<_i38.AnalyticsService>()));
  gh.factory<_i67.LogoutUseCase>(
      () => _i67.LogoutUseCase(get<_i35.ViamService>()));
  gh.lazySingleton<_i68.PermissionsService>(() =>
      _i69.PermissionsServiceImpl(get<_i47.CameraPermissionDataSource>()));
  gh.factory<_i70.RequestCameraPermissionUseCase>(() =>
      _i70.RequestCameraPermissionUseCase(get<_i68.PermissionsService>()));
  gh.factory<_i71.ResourceDataSource>(
      () => _i71.ResourceDataSource(get<_i26.Viam>()));
  gh.factory<_i72.SensorDataSource>(
      () => _i72.SensorDataSource(get<_i26.Viam>()));
  gh.factory<_i73.SetLocationIdUseCase>(
      () => _i73.SetLocationIdUseCase(get<_i43.AppViamStore>()));
  gh.factory<_i74.SetOrganizationIdUseCase>(
      () => _i74.SetOrganizationIdUseCase(get<_i43.AppViamStore>()));
  gh.factory<_i75.SetRobotIdUseCase>(
      () => _i75.SetRobotIdUseCase(get<_i43.AppViamStore>()));
  gh.factory<_i76.SplashCubit>(() =>
      _i76.SplashCubit(get<_i49.CheckIfHasTokenAndRefreshTokenUseCase>()));
  gh.factory<_i77.ViamAppCameraService>(() => _i78.ViamAppCameraServiceImpl(
        get<_i46.CameraDataSource>(),
        get<_i29.ViamCameraDataToViamAppCameraDataMapper>(),
      ));
  gh.factory<_i79.ViamAppMovementService>(() => _i80.ViamAppMovementServiceImpl(
  ...
  gh.factory<_i81.ViamAppResourceService>(() => _i82.ViamAppResourceServiceImpl(
        get<_i71.ResourceDataSource>(),
        get<_i33.ViamResourceNameToViamAppResourceNameMapper>(),
      ));
  gh.factory<_i83.ViamAppSensorService>(() => _i84.ViamAppSensorServiceImpl(
        get<_i72.SensorDataSource>(),
        get<_i28.ViamAppResourceNameToViamResourceNameMapper>(),
        get<_i34.ViamSensorReadingsToViamAppSensorReadingsMapper>(),
      ));
  gh.factory<_i85.BoatService>(() => _i86.BoatServiceImpl(
        get<_i4.BoatBox>(),
        get<_i52.CurrentBoatStore>(),
      ));
  gh.factory<_i87.ChangeBoatNameUseCase>(
      () => _i87.ChangeBoatNameUseCase(get<_i85.BoatService>()));
  gh.factory<_i88.CheckConnectionUseCase>(
      () => _i88.CheckConnectionUseCase(get<_i85.BoatService>()));
  gh.factory<_i89.DeleteBoatUseCase>(
      () => _i89.DeleteBoatUseCase(get<_i85.BoatService>()));
  gh.factory<_i90.GetBoatsUseCase>(
      () => _i90.GetBoatsUseCase(get<_i85.BoatService>()));
  gh.factory<_i91.GetCameraDataUseCase>(
      () => _i91.GetCameraDataUseCase(get<_i77.ViamAppCameraService>()));
  gh.factory<_i92.GetCameraPermissionStatusUseCase>(() =>
      _i92.GetCameraPermissionStatusUseCase(get<_i68.PermissionsService>()));
  gh.factory<_i93.GetCameraVideoUseCase>(
      () => _i93.GetCameraVideoUseCase(get<_i77.ViamAppCameraService>()));
  gh.factory<_i94.GetCurrentBoatIdUseCase>(
      () => _i94.GetCurrentBoatIdUseCase(get<_i85.BoatService>()));
  gh.factory<_i95.GetLinearVelocityUseCase>(
      () => _i95.GetLinearVelocityUseCase(get<_i79.ViamAppMovementService>()));
  gh.factory<_i96.GetPostionUseCase>(
      () => _i96.GetPostionUseCase(get<_i79.ViamAppMovementService>()));
  gh.factory<_i97.GetResourceNamesUseCase>(
      () => _i97.GetResourceNamesUseCase(get<_i81.ViamAppResourceService>()));
  gh.factory<_i98.GetSensorDataUseCase>(
      () => _i98.GetSensorDataUseCase(get<_i83.ViamAppSensorService>()));
  gh.factory<_i99.MainCubit>(
      () => _i99.MainCubit(get<_i97.GetResourceNamesUseCase>()));
  ...
  gh.factory<_i101.OrganizationsCubit>(() => _i101.OrganizationsCubit(
        get<_i59.GetOrganizationsListUseCase>(),
        get<_i51.ConnectToRobotUseCase>(),
        get<_i63.GetTokenOrNullUseCase>(),
        get<_i57.GetOrganizationIdUseCase>(),
        get<_i74.SetOrganizationIdUseCase>(),
      ));
  gh.factory<_i102.RemoveCurrentBoatIdUseCase>(
      () => _i102.RemoveCurrentBoatIdUseCase(get<_i85.BoatService>()));
  gh.factory<_i103.SensorTileCubit>(() => _i103.SensorTileCubit(
        get<_i98.GetSensorDataUseCase>(),
        get<_i95.GetLinearVelocityUseCase>(),
        get<_i10.GetCurrentTimeUseCase>(),
      ));
  gh.factory<_i104.SetCurrentBoatIdUseCase>(
      () => _i104.SetCurrentBoatIdUseCase(get<_i85.BoatService>()));
  gh.factory<_i105.SettingsCubit>(() => _i105.SettingsCubit(
        get<_i90.GetBoatsUseCase>(),
        get<_i89.DeleteBoatUseCase>(),
        get<_i65.LogDeleteBoatEventUseCase>(),
        get<_i102.RemoveCurrentBoatIdUseCase>(),
        get<_i104.SetCurrentBoatIdUseCase>(),
        get<_i21.SubscribeToBoatUpdateStreamUseCase>(),
        get<_i50.ChoosePhotoForBoatUseCase>(),
        get<_i48.CapturePhotoForBoatUseCase>(),
        get<_i67.LogoutUseCase>(),
      ));
  gh.factory<_i106.SubscribeToCameraStreamUseCase>(() =>
      _i106.SubscribeToCameraStreamUseCase(get<_i77.ViamAppCameraService>()));
  gh.factory<_i107.WebrtcCameraCubit>(() => _i107.WebrtcCameraCubit(
        get<_i93.GetCameraVideoUseCase>(),
        get<_i106.SubscribeToCameraStreamUseCase>(),
        get<_i10.GetCurrentTimeUseCase>(),
      ));
  gh.factory<_i108.AddNewBoatUseCase>(
      () => _i108.AddNewBoatUseCase(get<_i85.BoatService>()));
  gh.factory<_i109.BoatListCubit>(() => _i109.BoatListCubit(
        get<_i90.GetBoatsUseCase>(),
        get<_i94.GetCurrentBoatIdUseCase>(),
        get<_i104.SetCurrentBoatIdUseCase>(),
      ));
  gh.factory<_i110.CameraTileCubit>(
      () => _i110.CameraTileCubit(get<_i91.GetCameraDataUseCase>()));
  gh.factory<_i111.ChangeBoatNameCubit>(() => _i111.ChangeBoatNameCubit(
        get<_i87.ChangeBoatNameUseCase>(),
        get<_i17.NotifyBoatNameUpdateUseCase>(),
      ));
  gh.factory<_i112.ConnectionErrorCubit>(() => _i112.ConnectionErrorCubit(
        get<_i51.ConnectToRobotUseCase>(),
        get<_i63.GetTokenOrNullUseCase>(),
        get<_i108.AddNewBoatUseCase>(),
        get<_i90.GetBoatsUseCase>(),
        get<_i11.GetRobotAddressUseCase>(),
      ));
  gh.factory<_i113.DashboardCubit>(() => _i113.DashboardCubit(
        get<_i90.GetBoatsUseCase>(),
        get<_i94.GetCurrentBoatIdUseCase>(),
        get<_i21.SubscribeToBoatUpdateStreamUseCase>(),
      ));
  gh.factory<_i114.LocationsPageCubit>(() => _i114.LocationsPageCubit(
        ...
        get<_i63.GetTokenOrNullUseCase>(),
        get<_i73.SetLocationIdUseCase>(),
        get<_i60.GetRobotIdUseCase>(),
        get<_i54.GetLocationIdUseCase>(),
        get<_i75.SetRobotIdUseCase>(),
      ));
  gh.factory<_i115.AddBoatCubit>(() => _i115.AddBoatCubit(
        get<_i108.AddNewBoatUseCase>(),
        get<_i88.CheckConnectionUseCase>(),
        get<_i104.SetCurrentBoatIdUseCase>(),
        get<_i92.GetCameraPermissionStatusUseCase>(),
        get<_i70.RequestCameraPermissionUseCase>(),
        get<_i64.LogAddBoatEventUseCase>(),
        get<_i25.Uuid>(),
        get<_i90.GetBoatsUseCase>(),
...
class _$FilePickerModule extends _i116.FilePickerModule {}

class _$FirebaseAnalyticsModule extends _i117.FirebaseAnalyticsModule {}

class _$NavigatorKeyModule extends _i118.NavigatorKeyModule {}

class _$ImagePickerModule extends _i119.ImagePickerModule {}

class _$CameraPermissionModule extends _i120.CameraPermissionModule {}

class _$SharedPreferencesModule extends _i121.SharedPreferencesModule {}

class _$UuidModule extends _i122.UuidModule {}

class _$ViamSdkModule extends _i123.ViamSdkModule {}
