...
import '../../sdk/viam_sdk.dart' as _i14;
...
import '../presentation/page/add_boat/cubit/add_boat_cubit.dart' as _i29;
import '../presentation/page/dashboard/cubit/dashboard_cubit.dart' as _i31;
...
import '../presentation/widgets/camera_tile/cubit/camera_tile_cubit.dart'
    as _i30;
import '../presentation/widgets/map_tile/cubit/map_tile_cubit.dart' as _i32;
import '../presentation/widgets/sensor_tile/cubit/sensor_tile_cubit.dart'
    as _i23;
import 'navigator_key_injectable.dart' as _i33;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i11.ViamDrawerCubit>(
      () => _i11.ViamDrawerCubit(get<_i5.BoatService>()));
  ...
  await gh.singletonAsync<_i14.ViamSdk>(
  ...
  gh.factory<_i16.CameraDataSource>(
      () => _i16.CameraDataSource(get<_i14.ViamSdk>()));
  gh.factory<_i17.ResourceDataSource>(
      () => _i17.ResourceDataSource(get<_i14.ViamSdk>()));
  ...
  gh.factory<_i20.SensorDataSource>(
      () => _i20.SensorDataSource(get<_i14.ViamSdk>()));
  ...
  gh.factory<_i26.ViamAppMovementSdkDataSource>(
      () => _i26.ViamAppMovementSdkDataSource(get<_i14.ViamSdk>()));
  ...
  gh.factory<_i29.AddBoatCubit>(() => _i29.AddBoatCubit(
        get<_i5.BoatService>(),
        get<_i18.ResourceService>(),
      ));
  gh.factory<_i30.CameraTileCubit>(
      () => _i30.CameraTileCubit(get<_i24.ViamAppCameraService>()));
  gh.factory<_i31.DashboardCubit>(
      () => _i31.DashboardCubit(get<_i18.ResourceService>()));
  gh.factory<_i32.MapTileCubit>(() => _i32.MapTileCubit(
...
class _$NavigatorKeyModule extends _i33.NavigatorKeyModule {}

class _$ViamModule extends _i34.ViamModule {}
