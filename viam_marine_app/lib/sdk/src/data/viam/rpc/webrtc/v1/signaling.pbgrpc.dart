...
class SignalingServiceClient extends $grpc.Client {
  ...
  static final _$optionalWebRTCConfig =
      $grpc.ClientMethod<$0.OptionalWebRTCConfigRequest, $0.OptionalWebRTCConfigResponse>(
  ...
  $grpc.ResponseStream<$0.AnswerRequest> answer($async.Stream<$0.AnswerResponse> request,
...
abstract class SignalingServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.CallUpdateResponse> callUpdate_Pre(
      $grpc.ServiceCall call, $async.Future<$0.CallUpdateRequest> request) async {
