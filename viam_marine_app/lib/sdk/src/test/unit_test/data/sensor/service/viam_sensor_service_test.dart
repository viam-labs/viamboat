...
import 'package:viam_marine/sdk/src/test/unit_test/mocks/mock_response_future.dart';
import 'package:viam_marine/sdk/src/test/unit_test/mocks/service_clients_mocks.mocks.dart';
  ...
  group('ViamSensorService', () {
    group('getSensorData', () {
      ...
      test('gets data successfully', () async {
        ...
        final List<ViamSensorReadings> actualAnswer =
            await sensorService.getSensorData([viamResourceName], sensorsRequestName);
