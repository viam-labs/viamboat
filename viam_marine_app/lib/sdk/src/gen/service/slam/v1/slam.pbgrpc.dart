...
class SLAMServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.GetPointCloudMapResponse> getPointCloudMap(
      $0.GetPointCloudMapRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getPointCloudMap, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetInternalStateResponse> getInternalState(
      $0.GetInternalStateRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getInternalState, request, options: options);
  }
...
abstract class SLAMServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.GetPointCloudMapResponse> getPointCloudMap_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetPointCloudMapRequest> request) async {
    return getPointCloudMap(call, await request);
  }

  $async.Future<$0.GetInternalStateResponse> getInternalState_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetInternalStateRequest> request) async {
    return getInternalState(call, await request);
  }
  ...
  $async.Future<$0.GetPointCloudMapResponse> getPointCloudMap(
      $grpc.ServiceCall call, $0.GetPointCloudMapRequest request);
  $async.Future<$0.GetInternalStateResponse> getInternalState(
