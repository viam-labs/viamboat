...
const TrainingStatus$json = const {
  ...
  '2': const [
    ...
    const {'1': 'TRAINING_STATUS_SUBMITTING', '2': 5},
  ],
};

/// Descriptor for `TrainingStatus`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List trainingStatusDescriptor = $convert.base64Decode('');
...
const SubmitTrainingJobRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'model_name', '3': 3, '4': 1, '5': 9, '10': 'modelName'},
    const {'1': 'model_version', '3': 4, '4': 1, '5': 9, '10': 'modelVersion'},
    const {'1': 'model_type', '3': 5, '4': 1, '5': 14, '6': '.viam.app.data.v1.ModelType', '10': 'modelType'},
    const {'1': 'tags', '3': 6, '4': 3, '5': 9, '10': 'tags'},
  ],
};

/// Descriptor for `SubmitTrainingJobRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List submitTrainingJobRequestDescriptor = $convert.base64Decode('');
...
const GetTrainingJobResponse$json = const {
  ...
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'metadata', '3': 2, '4': 1, '5': 11, '6': '.viam.app.data.v1.TrainingJobMetadata', '10': 'metadata'},
  ],
};

/// Descriptor for `GetTrainingJobResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getTrainingJobResponseDescriptor = $convert.base64Decode('ChZHZXRUcmFpbmluZ0pvYlJlc3BvbnNlEg4KAmlkGAEgASgJUgJpZBJBCghtZXRhZGF0YRgCIAEoCzIlLnZpYW0uYXBwLmRhdGEudjEuVHJhaW5pbmdKb2JNZXRhZGF0YVIIbWV0YWRhdGE=');
@$core.Deprecated('Use trainingJobMetadataDescriptor instead')
const TrainingJobMetadata$json = const {
  '1': 'TrainingJobMetadata',
  '2': const [
    const {'1': 'request', '3': 1, '4': 1, '5': 11, '6': '.viam.app.data.v1.SubmitTrainingJobRequest', '10': 'request'},
    const {'1': 'status', '3': 2, '4': 1, '5': 14, '6': '.viam.app.data.v1.TrainingStatus', '10': 'status'},
    const {'1': 'created_on', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createdOn'},
    const {'1': 'last_modified', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'lastModified'},
    const {'1': 'synced_model_id', '3': 5, '4': 1, '5': 9, '10': 'syncedModelId'},
  ],
};

/// Descriptor for `TrainingJobMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List trainingJobMetadataDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use trainingJobDescriptor instead')
const TrainingJob$json = const {
  '1': 'TrainingJob',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'id'},
    const {'1': 'metadata', '3': 2, '4': 1, '5': 11, '6': '.viam.app.data.v1.TrainingJobMetadata', '8': const {}, '10': 'metadata'},
    const {'1': 'output_path', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'outputPath'},
    const {'1': 'vertex_job_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'vertexJobId'},
    const {'1': 'model_metadata', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '8': const {}, '10': 'modelMetadata'},
  ],
};

/// Descriptor for `TrainingJob`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List trainingJobDescriptor = $convert.base64Decode('');
