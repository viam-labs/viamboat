...
import 'package:viam_marine/sdk/src/domain/web_rtc/web_rtc_client/web_rtc_client_connection.dart';
...
class WebRtcClientChannel extends ClientChannelBase {
  ...
  void addOnMessageListener(Function(RTCDataChannelMessage data) listener) =>
