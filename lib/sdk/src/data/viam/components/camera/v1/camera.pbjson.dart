...
const GetImageResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'width_px', '3': 3, '4': 1, '5': 3, '10': 'widthPx'},
    const {'1': 'height_px', '3': 4, '4': 1, '5': 3, '10': 'heightPx'},
  ],
};

/// Descriptor for `GetImageResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getImageResponseDescriptor = $convert.base64Decode('ChBHZXRJbWFnZVJlc3BvbnNlEhsKCW1pbWVfdHlwZRgBIAEoCVIIbWltZVR5cGUSFAoFaW1hZ2UYAiABKAxSBWltYWdlEhkKCHdpZHRoX3B4GAMgASgDUgd3aWR0aFB4EhsKCWhlaWdodF9weBgEIAEoA1IIaGVpZ2h0UHg=');
