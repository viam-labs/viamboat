...
//  source: viam/components/camera/v1/camera.proto
//
// @dart = 2.12
...
class GetImageResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetImageResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.component.camera.v1'), createEmptyInstance: create)
    ...
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'widthPx')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'heightPx')
    ..hasRequiredFields = false
  ;
  ...
  factory GetImageResponse({
    ...
    $fixnum.Int64? widthPx,
    $fixnum.Int64? heightPx,
  }) {
    final _result = create();
    if (mimeType != null) {
      _result.mimeType = mimeType;
  ...
  @$pb.TagNumber(3)
  $fixnum.Int64 get widthPx => $_getI64(2);
  @$pb.TagNumber(3)
  set widthPx($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $fixnum.Int64 get heightPx => $_getI64(3);
  @$pb.TagNumber(4)
  set heightPx($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasHeightPx() => $_has(3);
  @$pb.TagNumber(4)
  void clearHeightPx() => clearField(4);
}
