...
//  source: viam/common/v1/common.proto
//
// @dart = 2.12
...
class WorldState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorldState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'viam.common.v1'), createEmptyInstance: create)
    ...
    ..pc<GeometriesInFrame>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interactionSpaces', $pb.PbFieldType.PM, subBuilder: GeometriesInFrame.create)
  ...
  factory WorldState({
    ...
    $core.Iterable<GeometriesInFrame>? interactionSpaces,
    ...
    if (interactionSpaces != null) {
      _result.interactionSpaces.addAll(interactionSpaces);
    }
    if (transforms != null) {
  ...
  @$pb.TagNumber(2)
  $core.List<GeometriesInFrame> get interactionSpaces => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<Transform> get transforms => $_getList(2);
}
